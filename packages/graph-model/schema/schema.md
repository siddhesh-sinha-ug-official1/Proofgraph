...
Index 0 is worst. Unrecognized token: rank WORST and report the offending token. Banned tokens: none/green.

worstTokenToStatus: red->red, amber->amber, blue->blue, definition->blue, lemma->green, none->green, green->green
